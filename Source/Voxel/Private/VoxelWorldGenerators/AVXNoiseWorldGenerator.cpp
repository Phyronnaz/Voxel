...
#include "AVXNoiseWorldGenerator.h"

UAVXNoiseWorldGenerator::UAVXNoiseWorldGenerator()
	: Noise()
{
}

void UAVXNoiseWorldGenerator::GetValuesAndMaterials(float Values[], FVoxelMaterial Materials[], const FIntVector& Start, const FIntVector& StartIndex, const int Step, const FIntVector& Size, const FIntVector& ArraySize) const
{
...
void UAVXNoiseWorldGenerator::SetVoxelWorld(AVoxelWorld* VoxelWorld)
{
